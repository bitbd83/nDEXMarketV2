  ...
  var define, module, exports;return function () {
    function r(e, n, t) {
      ...
      module.exports = {
        ...
        description: {
          en: 'DEx is a decentralized exchange for Ethereum tokens.',
          cn: 'DEx是去中心化的以太坊交易平台。',
          fr: "DEx est une bourse d'échange de jetons ethereum décentralisé.",
          es: 'DEx se ha posicionado como la primera bolsa de cambio de cryptomonedas y symbolicos de la blockchain Ethereum.'
        },
        Smart_Contract: {
          en: 'Smart Contract',
          cn: '智能合约',
        ...
        only_7_days: {
          en: 'Note: DEx will only show recent transactions.',
          cn: '注意：DEx只会显示最近的交易。',
          fr: 'Remarque: DEx affichera uniquement les transactions récentes.',
          es: 'Nota: DEx sólo mostrará transacciones recientes.'
        },
        ...
        dex_desc: {
          en: 'DEx &#8212; decentralized token exchange',
          cn: 'DEx &#8212; 去中心化交易',

          fr: 'DEx &#8212; échange de jetons décentralisé',
          es: 'DEx &#8212; échange de jetons décentralisé'
        },
        etheropt_desc: {
        ...
        aug032016_announcement: {
          en: 'DEx has moved to a new smart contract. Go to the bottom of the page and switch to the old one if you have a balance there you need to withdraw.',
          cn: 'DEx更新了智能合约。如果你要提取余额，请到本页底部转成旧的合约并进行提取。',

          fr: "DEx a ete modifié pour un nouveau smart contract. Allez au bas de page et permutez le avec l'ancien s'il reste du solde à retirer."
        },
        aug302016: {
          en: 'August 30, 2016',
          cn: '2016年8月3日',
        ...
        aug302016_announcement: {
          ...
          fr: "DEx utilise un nouveau smart contract. Allez au bas de page et permutez le avec l'ancien s'il vous reste du solde à retirer.",
          es: 'DEx utiliza un nuevo contrato inteligente.'
        },
        new_account: {
          en: 'New account',
          cn: '新账号',
        ...
        deposit_withdraw_2: {
          en: 'Under "Balances," you will see your balance for each of the two currencies you selected. This is the balance you have deposited to DEx from your Ethereum account.',
          cn: '在“余额”下面，你可以看到两种币的各自的余额，这是从你的以太坊账号充值的余额。',
          fr: 'Sous "Soldes" vous trouverez le solde pour chacune des deux devises selectionnées. C\'est le solde que vous venez de déposer sur DEx depuis votre compte Ethereum',
        ...
        deposit_withdraw_4: {
          en: 'To deposit, click the "Deposit" tab, pick a token, enter an amount you would like to deposit from your Ethereum account into DEx, and click "Deposit."',
          cn: '充值点“充值”，选择一种币，输入从以太坊账号进入DEx的充值数量，再点“充值”。',
          fr: 'Pour déposer, cliquer sur "Deposit" tab, choisir un jeton, entrer le montant à déposer depuis votre compte Ethereum vers DEx, puis cliquer "Deposit".',
          es: 'Para abonar, haga clic en la pestaña "depósito", elegir un modo, ingrese la cantidad a depositar desde su cuenta a Etereum DEx y haga clic en "depósito.'
        },
        deposit_withdraw_5: {
        ...
        trade_3: {
          en: 'DEx supports resting orders (adding liquidity) and trading against existing resting orders (taking liquidity).',
          cn: 'DEx支持“待定下单”（resting order）来增加流动性，以及交易“待定下单”来减少流动性。',
          fr: "DEx supportes les ordres restant (l'ajout de liquidite) et marchander contre des ordres restant (prise de liquidite).",
          es: 'DEx apoya descansando órdenes tales como la adición de liquidez y el comercio contre órdenes existentes como descansando Tomando liquidez..'
        },
        trade_4: {
        ...
        trade_6: {
          en: 'When you submit a resting order, it gets broadcast to the world. The current broadcast channel is a Gitter chat room, but DEx also supports using Ethereum events as a fallback broadcast mechanism.',
          cn: '但你提交了一个“待定下单”后，它会广播到全球。现在的传播渠道是Gitter聊天室，但是DEx也支持以太坊事件机制，用来保底。',
          fr: "Quand vous soumettez un ordre restant, il se diffuse dans le monde entier. Le canal de causerie principal s'appele Gitter chat room, mais DEx supporte egalement des evenements ethereum en tant que moyen de diffusion alternative.",
          es: 'Cuando se envía una orden de reposo, que se transmitió al mundo. El canal de difusión actual es una sala de chat Gitter, DEx también promueve eventos Ethereum como un medio alternativo de distribución.'
        },
        trade_7: {
